(function() {
  ...
  const BUX = (function() {
    ...
    BUX.prototype.activities = function(callback) {
      return this.get('social/activities', {}, callback);
    };

    BUX.prototype.activitiesFollowed = function(callback) {
      return this.get('users/me/social/activities', {}, callback);
    };
    ...
    BUX.prototype.resolveProductId = function(productId, callback) {
      ...
      return callback(this.findProductBySymbol(productId) || productId);
    };
