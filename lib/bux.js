(function() {
  ...
  const BUX = (function() {
    ...
    BUX.prototype.notifications = function(callback) {
      return this.get('users/me/notifications', callback);
    };
    ...
    BUX.prototype.group = function(groupId, callback) {
      return this.get('groups/' + groupId, callback);
    };

    BUX.prototype.groupFollow = function(groupId, callback) {
      return this.put('groups/' + groupId + '/follow', {}, callback);
    };

    BUX.prototype.groupUnfollow = function(groupId, callback) {
      return this.delete('users/me/groups/' + groupId, callback);
    };

    BUX.prototype.groupFeed = function(groupId, callback) {
      return this.get('groups/' + groupId + '/feed', callback);
    };

    BUX.prototype.groupFeedCursor = function(groupId, callback) {
      return this.get('users/me/groups/' + groupId + '/feed/cursor', callback);
    };

    BUX.prototype.groupFeedCursorUpdate = function(groupId, lastReadFeedItemId, callback) {
      return this.put('users/me/groups/' + groupId + '/feed/cursor/' + lastReadFeedItemId, {}, callback);
    };

    BUX.prototype.groupFeedAdd = function(groupId, message, callback) {
      return this.post('groups/' + groupId + '/feed/chat', { message: message }, callback);
    };

    BUX.prototype.groupFeedDelete = function(groupId, messageId, callback) {
      return this.delete('groups/' + groupId + '/feed/chat/' + messageId, callback);
    };

    BUX.prototype.groupRole = function(groupId, callback) {
      return this.get('users/me/groups/' + groupId + '/role', callback);
    };

    BUX.prototype.groupMemberPortfolio = function(groupId, memberId, callback) {
      return this.get('groups/' + groupId + '/members/' + memberId + '/portfolio', callback);
    };

    BUX.prototype.groupFollowersPreview = function(groupId, callback) {
      return this.get('groups/' + groupId + '/followerspreview', callback);
    };

    BUX.prototype.groupSettings = function(groupId, settings, callback) {
      return this.put('users/me/groups/' + groupId + '/settings', settings, callback);
    };

    BUX.prototype.allowedGroups = function(callback) {
      return this.get('users/me/groups/allowed', callback);
    };

    BUX.prototype.allowedBattles = function(callback) {
    ...
    BUX.prototype.battleSettings = function(battleId, settings, callback) {
      return this.put('users/me/battles/' + battleId + '/settings', {}, callback);
    };
    ...
    BUX.prototype.productAlert = function(productId, targetPrice, callback) {
      ...
      return this.put('users/me/products/' + productId + '/tracker', opts, callback);
    };
    ...
    BUX.prototype.productAlertDelete = function(productId, callback) {
      ...
      return this.delete('users/me/products/' + productId + '/tracker', callback);
    };
    ...
    BUX.prototype.subscribeProducts = function(products, callback) {
      var self = this;
      var arr = products.map(function(p) {
        var id = self.findProductBySymbol(p);
        if(!id) { return callback('product not found: ' + p); }
        return 'product.' + id;
      });
      this.subscribe(arr, callback);
    };
